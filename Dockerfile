...
RUN apk add --no-cache ca-certificates git build-base && \
    ...
    echo "#APPSEC_URL=http://127.0.0.1:7422 # see https://github.com/crowdsecurity/lua-cs-bouncer/issues/44" | tee -a /src/crowdsec-nginx-bouncer/lua-mod/config_example.conf && \
    echo "#APPSEC_FAILURE_ACTION=deny # see https://github.com/crowdsecurity/lua-cs-bouncer/issues/44" | tee -a /src/crowdsec-nginx-bouncer/lua-mod/config_example.conf && \
